...
const CardContact = (props ) => {
  ...
  return (
   ...
   <p style={{color:'black',fontSize:'18px'}}> { props.item.nom}: الإسم</p>

   <p style={{color:'black',fontSize:'18px'}}> { props.item.email}:بريد إلكتروني</p>
   <p style={{color:'black',fontSize:'18px'}}>  { props.item.telephone}: رقم الهاتف</p>
